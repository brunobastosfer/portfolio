  ...
  return (
    <div className="flex flex-col bg-zinc-300 rounded-2xl text-black overflow-hidden">
      ...
      </div>
      {
        ...
        <div className="flex items-center gap-2 m-4 rounded-full h-10 bg-white">
          <input className="flex-1 bg-transparent h-8 outline-none pl-3" type="text" value={texto} onChange={(e) => {
          ...
          />
          <button onClick={enviarMensagem} className="flex justify-center items-center min-h-8 min-w-8 rounded-full mr-1 bg-red-500">
