  ...
  return (
    <div>
      <nav className="flex gap-6">
        ...
        <MenuItem href="http://api.whatsapp.com/send/?phone=5585981474352&text=Gostei%20do%20portf%C3%B3lio%20e%20gostaria%20de%20conversar%20com%20voc%C3%AA.&type=phone_number" selecionado={false} novaAba={true}>
          Contato
        </MenuItem>
      </nav>
    </div>
